...
PASS_CONFIG_DIR="${XDG_CONFIG_HOME:-$HOME/.config}/pass"
...
run_cmd "Remove pass config directory" rm -rf "$PASS_CONFIG_DIR"

info "Pass clean hook complete"
