...
INSTALL_LIST="$FONTS_CONFIG_DIR/install"
...
run_cmd "Create fonts config directory" mkdir -p "$FONTS_CONFIG_DIR"
run_cmd "Ensure install list exists" touch "$INSTALL_LIST"

info "Fonts pre hook complete"
