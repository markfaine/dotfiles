...
run_cmd "Create tools config directory" mkdir -p "$TOOLS_CONFIG_DIR"
run_cmd "Ensure tools sources file exists" touch "$TOOLS_CONFIG"

info "Tools pre hook complete"
