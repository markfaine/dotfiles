...
# Utilities Post Hook
# ==============================================================================
# Downloads and installs tools from ~/.config/utilities/.config/utilities/config
# that are not available via mise. Supports both binary files and archives.

UTILITIES_CONFIG="$HOME/.config/utilities/config"
INSTALL_DIR="$HOME/.local/bin"
LOG_DIR="$HOME/.config/utilities"
...
Downloads and installs utilities from config that aren't available via mise.
...
if [[ ! -f "$UTILITIES_CONFIG" ]]; then
	echo "Error: Config file not found: $UTILITIES_CONFIG" >&2
	exit 1
fi
...
debug_msg "Reading utilities config from: $UTILITIES_CONFIG"
...
done < "$UTILITIES_CONFIG"

echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "Utilities Installation Summary"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "Total:     $total"
